    ...
    features: [
      ...
      },
      {
        ...
        specifics: [
          ...
          'The Approved, Pending, and Rejected request panels in Overview show only the active user\'s own requests where the Until date is today or later. Each panel uses compact laptop-friendly spacing and keeps its own content height instead of stretching empty panels to match the tallest panel in the row.',
                ...
                <div className={`compensation-editor-row ${row.payType === PAY_TYPE_PROJECT ? 'project-compensation-row' : ''}`} key={row.id}>
                  ...
                  {!monthly && !hourly && (
                    <>
                      ...
                      <label className="field compensation-project-date-field compensation-project-from-field">
                      ...
                      <label className="field compensation-project-date-field compensation-project-to-field">
